<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-3xl font-black text-slate-800 tracking-tight">Ver Lista</h2>
    ...
    <div class="py-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {{-- Columna Izquierda: Datos de la lista (Readonly) --}}
            <div class="space-y-6">
    ...
    <script>
        ...
        /**
         * Renderiza la tabla de visualización de invitados aplicando paginación visual y controlando los botones.
         */
