<div id="modalSelection" 
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <!-- Fondo oscuro -->
        <button type="button" tabindex="-1" class="fixed inset-0 w-full h-full bg-gray-500/50 transition-opacity cursor-default" onclick="closeModal('modalSelection')" aria-label="Cerrar modal"></button>
