        ...
        <div class="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-200 relative overflow-hidden group shadow-sm">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">REMAINING TIME</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm transition-all duration-300">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-[9px] font-black text-slate-400 bg-slate-50 px-3 py-1 rounded-full border border-slate-100 uppercase tracking-widest">General</span>
                    </div>
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Asistentes</p>
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-slate-100 transition-all duration-300">
                    <div class="flex items-center justify-between mb-4">
                        <div class="p-3 bg-slate-50 text-slate-400 rounded-xl border border-slate-100">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                        </div>
                    </div>
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Invitados</p>
                    <div class="flex items-baseline gap-2">
                        <p class="text-3xl font-black text-slate-700">30</p>
                        <p class="text-xs font-bold text-slate-400">/ 60 total</p>
                    </div>
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-slate-100 transition-all duration-300">
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Acompañantes</p>
                    <p class="text-3xl font-black text-slate-700">15</p>
                    <p class="text-[10px] font-medium text-slate-400 mt-3 italic">Extra confirmados</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-[2rem] border border-slate-100 transition-all duration-300">
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Regalos</p>
                    <div class="flex items-baseline gap-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <a href="{{ route('invitados.creacion') }}" class="flex items-center gap-4 p-5 bg-white border border-slate-100 rounded-3xl hover:border-slate-300 hover:shadow-md transition-all group">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400 uppercase font-bold tracking-tighter">Ver confirmaciones</p>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('regalos.index') }}" class="flex items-center gap-4 p-5 bg-white border border-slate-100 rounded-3xl hover:border-slate-300 hover:shadow-md transition-all group">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400 uppercase font-bold tracking-tighter">Actualizar catálogo</p>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="bg-white border border-slate-100 rounded-[2rem] overflow-hidden shadow-sm">
                    <div class="p-6 space-y-6">
                        ...
                        <div class="flex items-center gap-4 border-t border-slate-50 pt-6">
                            <div class="w-10 h-10 bg-slate-50 text-slate-400 border border-slate-100 rounded-full flex items-center justify-center">
